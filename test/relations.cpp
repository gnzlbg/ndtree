...
int main() {
  ...
  {
    // child 0
    static_assert(relative_child_position<3>(0)[0] == -1, "");
    static_assert(relative_child_position<3>(0)[1] == -1, "");
    static_assert(relative_child_position<3>(0)[2] == -1, "");
    // child 1
    static_assert(relative_child_position<3>(1)[0] == 1, "");
    static_assert(relative_child_position<3>(1)[1] == -1, "");
    static_assert(relative_child_position<3>(1)[2] == -1, "");
    // child 2
    static_assert(relative_child_position<3>(2)[0] == -1, "");
    static_assert(relative_child_position<3>(2)[1] == 1, "");
    static_assert(relative_child_position<3>(2)[2] == -1, "");
    // child 3
    static_assert(relative_child_position<3>(3)[0] == 1, "");
    static_assert(relative_child_position<3>(3)[1] == 1, "");
    static_assert(relative_child_position<3>(3)[2] == -1, "");
    // child 4
    static_assert(relative_child_position<3>(4)[0] == -1, "");
    static_assert(relative_child_position<3>(4)[1] == -1, "");
    static_assert(relative_child_position<3>(4)[2] == 1, "");
    // child 5
    static_assert(relative_child_position<3>(5)[0] == 1, "");
    static_assert(relative_child_position<3>(5)[1] == -1, "");
    static_assert(relative_child_position<3>(5)[2] == 1, "");
    // child 6
    static_assert(relative_child_position<3>(6)[0] == -1, "");
    static_assert(relative_child_position<3>(6)[1] == 1, "");
    static_assert(relative_child_position<3>(6)[2] == 1, "");
    // child 7
    static_assert(relative_child_position<3>(7)[0] == 1, "");
    static_assert(relative_child_position<3>(7)[1] == 1, "");
    static_assert(relative_child_position<3>(7)[2] == 1, "");
  }
